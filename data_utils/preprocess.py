...
if __name__ == '__main__':
    ...
    # Using classmethod (TxtProcessor interface)
    print("\n=== Using TxtProcessor classmethod ===")
    ph, txt, word, ph2word, ph_gb_word = TxtProcessor.txt_to_ph(test_text)
    print("Phonemes:", ph)
    print("Cleaned text:", txt)
    print("Words:", word)
    print("Phoneme to word mapping (first 10):", ph2word[:10])
    print("Phonemes grouped by word:", ph_gb_word)
    
    # Using static method (same as libri_emo_preprocess.py pattern)
    print("\n=== Using static method (libri_emo_preprocess.py pattern) ===")
    txt_processor = TxtProcessor()
    ph, txt, word, ph2word, ph_gb_word = TxtProcessor.txt_to_ph_static(txt_processor, test_text)
    print("Phonemes:", ph)
    print("Cleaned text:", txt)
    print("Words:", word)
    print("Phoneme to word mapping (first 10):", ph2word[:10])
