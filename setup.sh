...
brew install gdown
gdown --fuzzy https://drive.google.com/file/d/1kNjYBqv_DohG8N3wF-J7kCSBmLxvs77N/view?usp=sharing && unzip TextrolSpeech_data.tar.gz -d TexttrolSpeech_data
gdown --fuzzy https://drive.google.com/file/d/1W9DuRsQuP3tfWwxFo0Dx8-Rg-XbGCIzH/view?usp=sharing && unzip CREMA-D.zip -d CREMA-D
